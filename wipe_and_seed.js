...
async function wipeAndSeed() {
  ...
  if (allProds) {
    ...
    console.log('Wiped all ' + allProds.length + ' old products from Supabase!');
  }
  ...
  if (error) {
    ...
    console.log('Inserted exactly ' + newProducts.length + ' fresh, unique products!');
  }
}
