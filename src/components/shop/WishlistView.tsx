...
export const WishlistView = () => {
  const { wishlist, setCurrentView, products, goBack } = useAppContext();
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen bg-white dark:bg-[#0A0A0A] text-gray-900 dark:text-gray-100 transition-colors duration-500 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-500 dark:text-white uppercase tracking-widest text-xs font-semibold">
      ...
      {wishlist.length === 0 ? (
        <div className="text-center py-20 flex flex-col items-center">
          <p className="text-gray-500 dark:text-white text-lg mb-8 font-serif italic">Your wishlist is currently empty.</p>
          <button
