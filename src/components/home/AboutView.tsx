    ...
    <div className="pt-24 pb-24 min-h-screen bg-white dark:bg-[#0A0A0A] text-gray-900 dark:text-gray-100 transition-colors duration-500">
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8 relative z-10 w-44 h-44 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-[#DFB722] shadow-[0_20px_50px_rgba(0,0,0,0.4)] ring-8 ring-white/10 flex items-center justify-center hover:scale-105 transition-transform duration-300 bg-transparent"
        >
          <Users className="w-24 h-24 md:w-32 md:h-32 text-[#DFB722] drop-shadow-[0_0_20px_rgba(223,183,34,0.8)]" strokeWidth={2.5} />
        </motion.div>
        ...
        >
          Samstones
          <br />
          <span className="font-medium tracking-wide text-[#DFB722]">Marketplace</span>
        </motion.h1>
      </div>
