    ...
    <div className="min-h-screen bg-white dark:bg-[#0A0A0A] text-gray-900 dark:text-gray-100">
      ...
      <div className="relative w-full bg-[#109121] flex flex-col items-center justify-center text-center px-4 py-20 overflow-hidden">
        ...
        >
          <img
            src="/logo.png.jpg"
            alt="Samstones International Resources Ltd"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          ...
          <Section num="1" title="GENERAL">
            <SubSection title="1.1 Company Information">
              <p>Samstones International Resources Ltd is a registered business operating in Lagos State, Nigeria.</p>
            </SubSection>
            <SubSection title="1.2 Definitions">
              <ul className="list-disc pl-5 space-y-1">
                <li><strong>"Company", "We", "Us", or "Our"</strong> refers to Samstones International Resources Ltd.</li>
          ...
          <Section num="3" title="PRICING &amp; PAYMENT">
            ...
            <SubSection title="3.3 Accepted Payment Methods">
              ...
              <p className="mt-2">All payments must be made only to official company accounts bearing the name <strong>Samstones International Resources Ltd</strong>.</p>
            </SubSection>
          ...
          <Section num="4" title="ORDERS &amp; ACCEPTANCE">
            ...
            <SubSection title="4.2 Order Confirmation">
              <p>An order shall only be deemed confirmed after the customer receives an official receipt, invoice, or confirmation message from Samstones International Resources Ltd.</p>
            </SubSection>
          </Section>
          ...
          <Section num="7" title="WARRANTY &amp; LIABILITY">
            ...
            <SubSection title="7.2 Limitation of Liability">
              <p className="mb-2">Samstones International Resources Ltd shall not be liable for:</p>
              <ul className="list-disc pl-5 space-y-1">
          ...
          <Section num="8" title="CUSTOMER RESPONSIBILITIES">
            <p className="text-gray-600 leading-relaxed mb-2">Customers agree to:</p>
            ...
            <p className="text-gray-600 leading-relaxed mt-3">Customers purchasing age-restricted items such as alcoholic drinks must be at least <strong>18 years old</strong> and may be required to present valid identification.</p>
          </Section>

          {/* Section 9 */}
          <Section num="9" title="INTELLECTUAL PROPERTY">
            <p className="text-gray-600 leading-relaxed">All logos, trademarks, product images, website content, graphics, and materials belonging to Samstones International Resources Ltd remain our intellectual property and may not be copied, reproduced, distributed, or used without prior written consent.</p>
          </Section>

          {/* Section 10 */}
          <Section num="10" title="PRIVACY POLICY">
            <p className="text-gray-600 leading-relaxed mb-2">We collect and process customer information solely for:</p>
            <ul className="list-disc pl-5 space-y-1 text-gray-600">
              <li>Order fulfilment,</li><li>Delivery services,</li><li>Customer support, and</li>
              <li>Compliance with legal obligations.</li>
            </ul>
            <p className="text-gray-600 leading-relaxed mt-3">Customer information shall be handled in accordance with applicable data protection laws and our Privacy Policy.</p>
          </Section>

          {/* Section 11 */}
          <Section num="11" title="FORCE MAJEURE">
            <p className="text-gray-600 leading-relaxed mb-2">We shall not be held liable for delays or failure to perform obligations due to events beyond our reasonable control, including but not limited to:</p>
            <ul className="list-disc pl-5 space-y-1 text-gray-600">
          ...
          <Section num="12" title="GOVERNING LAW &amp; DISPUTE RESOLUTION">
            ...
            <SubSection title="12.2 Dispute Resolution">
              <p className="mb-2">Any dispute arising from transactions with Samstones International Resources Ltd shall first be resolved amicably through negotiation. Where unresolved, such disputes shall be submitted to:</p>
              <ul className="list-disc pl-5 space-y-1">
          ...
          <Section num="13" title="CONTACT INFORMATION">
            <div className="bg-[#e6f4e8] border border-[#109121]/20 rounded-2xl p-6 space-y-2">
              <p className="font-bold text-gray-900 text-lg">Samstones International Resources Ltd</p>
              <p className="text-gray-700 flex items-start gap-2">
                <span>📍</span>
                <span>Zone C House 2, Agunmo, Ilogbo Eremi, Olorunda LCDA, Lagos State, Nigeria</span>
              </p>
              <p className="text-gray-700 flex items-center gap-2">
                <span>📞</span>
                <a href="tel:+2347082930862" className="hover:text-[#109121] transition-colors">+234 708 293 0862</a>
                <span>/</span>
                <a href="tel:+2348065179554" className="hover:text-[#109121] transition-colors">+234 806 517 9554</a>
              </p>
              <p className="text-gray-700 flex items-center gap-2">
                <span>💬</span>
                <a href="https://wa.me/2348065179554" target="_blank" rel="noopener noreferrer" className="hover:text-[#109121] transition-colors font-semibold">
                  Chat on WhatsApp
                </a>
              </p>
              <p className="text-gray-700 flex items-center gap-2">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 text-center text-xs text-gray-400">
          © {new Date().getFullYear()} Samstones International Resources Ltd. All rights reserved.
        </div>
      </div>
      </div>
    </div>
...
const Section = ({ num, title, children }: { num: string; title: string; children: React.ReactNode }) => (
  <section>
    <div className="flex items-center gap-4 mb-6">
      ...
      <h2 className="text-xl font-serif font-bold text-gray-900 tracking-tight">{title}</h2>
    </div>
...
const SubSection = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div>
    <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wider mb-2">{title}</h3>
    <div className="text-gray-600 leading-relaxed space-y-2 text-[0.95rem]">{children}</div>
  </div>
);
