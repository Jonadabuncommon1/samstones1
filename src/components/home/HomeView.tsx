      ...
      <section className="relative pt-24 pb-12 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative grid grid-cols-1 xl:grid-cols-2 gap-12 items-center rounded-3xl p-8 lg:p-12 shadow-2xl overflow-hidden">
          ...
          <div className="relative z-20 flex flex-col justify-center text-left">
            ...
            >
              Shop premium groceries, luxury vehicles, high-end real estate, and exclusive fashion, all sourced for <span className="text-[#DFB722] font-black">quality</span> and directly delivered.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center flex flex-col items-center">
              ...
              <h3 className="font-bold text-gray-900 text-lg mb-2"><span className="text-[#DFB722] font-black">Quality</span> Guarantee</h3>
