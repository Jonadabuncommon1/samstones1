            ...
            >
              ...
              <div className="flex flex-col justify-center leading-none">
                <span
                  ...
                  className="text-xl md:text-2xl lg:text-3xl tracking-wide text-[#E8B93D] dark:text-[#F3CE6E] transition-colors duration-300 drop-shadow-sm font-bold"
                >
                  Samstones
                </span>
              </div>
              ...
              <div className="flex justify-between items-center mb-8 border-b border-gray-100 dark:border-gray-800 pb-6">
                ...
                >
                  ...
                  <div className="flex flex-col justify-center leading-none">
                    <span
                      style={{ fontFamily: '"Ralika", serif' }}
                      className="text-xl md:text-2xl lg:text-3xl tracking-wide text-[#E8B93D] dark:text-[#F3CE6E] drop-shadow-sm font-bold"
                    >
                      Samstones
                    </span>
                  </div>
